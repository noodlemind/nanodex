    ...
    try:
        ...
        if model_source == 'huggingface':
            model_name = questionary.select(
                "Which base model?",
                choices=[
                    {'name': 'deepseek-ai/deepseek-coder-6.7b-base (recommended)', 'value': 'deepseek-ai/deepseek-coder-6.7b-base'},
        ...
        if mode in ['hybrid', 'full']:
            ...
            if api_provider != 'skip':
                api_key = questionary.password(
                    f"Enter your {api_provider.upper()} API key:",
                    style=custom_style
                ).ask()
                ...
                budget = questionary.text(
                    "Budget in USD for synthetic data:",
                    default="10.0",
                    style=custom_style
                ).ask()
